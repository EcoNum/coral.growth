...
[![Travis build status](https://travis-ci.com/EcoNum/coral.growth.svg?branch=master)](https://travis-ci.com/EcoNum/coral.growth)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/EcoNum/coral.growth?branch=master&svg=true)](https://ci.appveyor.com/project/GuyliannEngels/coral-growth)
...
The latest stable version of `coral.growth` can simply be installed from Github with :
...
<img src="man/figures/EcoNum-logo.png" width="70" height="70" align="left"/>  This package is developped for the Numerical Ecology of Aquatic Systems.
